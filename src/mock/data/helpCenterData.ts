...
export const articleListData = [
    ...
    },
    {
        ...
        content:
            'Interactive dashboard can significantly enhance data comprehension and engagement. This guide walks you through the process of creating dynamic and interactive dashboard using popular tools.',
        category: 'dataVisualization',
        authors: [
            {
