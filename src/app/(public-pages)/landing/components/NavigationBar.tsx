        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative border border-gray-200 dark:border-gray-700 rounded-full inline-flex items-center justify-center gap-0 py-1 px-2 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <img
