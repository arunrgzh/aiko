...
import CollapsibleSide from '@/components/layouts/AssistantsLayout/components/CollapsibleSide'

interface AssistantsLayoutProps extends CommonProps {
    layoutType: LayoutType
}



const Layout = ({ children, layoutType }: AssistantsLayoutProps) => {
    switch (layoutType) {
...
const AssistantsLayout = ({ children }: CommonProps) => {
