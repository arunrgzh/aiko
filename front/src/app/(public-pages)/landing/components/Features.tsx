...
const Features = ({ mode, onModeChange, schema, setSchema }: FeaturesProps) => {
    ...
    const renderComponentIcon = (item: {
        ...
        return (
            <a
                ...
                target="_blank"
                rel="noreferrer"
                className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 h-26 w-26 flex items-center justify-center rounded-2xl"
            >
    ...
    const socialMediaItems = Object.entries(componentsIcons)
        .filter(([key]) => key.startsWith('socialMedia'))
        .map(([key]) => ({
            id: key,
            name: key.replace('socialMedia', ''), // e.g., "socialMediaFacebook" -> "Facebook"
            link: `https://www.${key.replace('socialMedia', '').toLowerCase()}.com`, // Example link
        }))
                    ...
                    <div className="col-span-2">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    <h4 className="font-bold">{t('mode')} </h4>
                                    <p className="mt-2">{t('mode-sub')}</p>
                                </div>
                            </Card>
                            <Card
                                initial={{ opacity: 0, y: 40 }}
                            ...
                            >
                                        ...
                                        <div className="p-2 border border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-700 rounded-lg relative shadow-2xl dark:shadow-white/40">
                                            {mode === 'light' && (
                                                <Image
                                                    ...
                                                    src="/img/landing/layouts/chat.png"
                                                    width={630}
                                                    height={562}
                                ...
                                <div className="mt-6">
                                    <h4 className="font-bold">{t('auto')} </h4>
                                    <p className="mt-2">{t('auto-sub')}</p>
                                </div>
                            </Card>
                        </div>
                        <div className="mt-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    <h4 className="font-bold">{t('panel')}</h4>
                                    <p className="mt-2">{t('panel-sub')}</p>
                                </div>
                            </Card>
                        </div>
                    </div>
                                ...
                                >
                                    <div className="min-h-[270px] flex items-center justify-center w-full">
                                        <div className="h-[38.5rem] rounded-md flex flex-col antialiased items-center justify-center relative overflow-hidden">
                                            <div className="h-[38.5rem] flex flex-col gap-4">
                                                <InfiniteMovingCards
